...
docx_path = 'c:/Users/Chami/Downloads/Malika/Photos/Mahogany Plate wall decoration.docx'
...
with open('c:/Users/Chami/Downloads/Malika/Photos/document_flow.txt', 'w', encoding='utf-8') as f:
    f.write('\n'.join(out))

print("Document flow saved successfully to document_flow.txt")
